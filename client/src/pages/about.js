  ...
  root.innerHTML = `
    <section class="section">
      <div class="wrap">
        ...
        <p class="section-sub reveal" style="margin-bottom:64px">
        ...
        <div style="display:grid;grid-template-columns:2fr 1fr;gap:60px;align-items:start">
          <!-- Bio -->
          <div>
            <div class="card reveal" style="margin-bottom:24px;border-left:3px solid var(--accent)">
              <p style="font-size:1.08rem;line-height:1.82;color:var(--text-soft)">
            ...
            <div class="card reveal" style="margin-bottom:24px">
              <p style="font-size:1rem;line-height:1.82;color:var(--text-soft)">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px">
              ${[
                ...
                <div class="card reveal" style="display:flex;align-items:center;gap:12px;padding:16px 20px">
                  <span style="font-size:1.3rem">${f.icon}</span>
                  <span style="font-size:0.88rem;font-weight:500;color:var(--text-soft)">${f.label}</span>
                </div>
              `).join('')}
            </div>
          </div>

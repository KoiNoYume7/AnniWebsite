      ...
      <div style="width:100%;max-width:420px">
        <div class="card reveal" style="padding:44px">
          ...
          <div id="oauth-buttons">
            <a class="oauth-btn oauth-github" href="${`/api/auth/github${returnTo ? '?returnTo=' + encodeURIComponent(returnTo) : ''}`}">
            ...
            <a class="oauth-btn oauth-discord" href="${`/api/auth/discord${returnTo ? '?returnTo=' + encodeURIComponent(returnTo) : ''}`}">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a class="oauth-btn oauth-google" href="${`/api/auth/google${returnTo ? '?returnTo=' + encodeURIComponent(returnTo) : ''}`}">

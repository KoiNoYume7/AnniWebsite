...
> The canonical Pi infrastructure reference has moved to **`AnniCore/INFRA.md`**.
> Do not edit this file — edit INFRA.md instead.
> Last accurate: 2026-04-24 (pre-AnniCore migration)
